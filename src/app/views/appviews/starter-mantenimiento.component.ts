...
@Component({
  selector: 'starter-mantenimiento',
  templateUrl: 'starter-mantenimiento.template.html'
})
export class StarterMantenimientoComponent implements OnDestroy, OnInit  {
  ...
  public lineChartData:Array<any> = [
    {data: [48, 48, 60, 39, 56, 37, 30], label: 'Gestión Documento'},
    {data: [65, 59, 40, 51, 36, 25, 40], label: 'Auditoria'},
  ];
