...
@Component({
  selector: 'starter-noconformidad',
  templateUrl: 'starter-noconformidad.template.html'
})
export class StarterNoConformidadComponent implements OnDestroy, OnInit  {
  ...
  public lineChartData:Array<any> = [
    {data: [48, 48, 60, 39, 56, 37, 30], label: 'No Conformidad'},
