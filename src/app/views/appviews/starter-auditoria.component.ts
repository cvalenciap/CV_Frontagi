...
@Component({
  selector: 'starter-auditoria',
  templateUrl: 'starter-auditoria.template.html'
  
})
export class StarterAuditoriaComponent implements OnDestroy, OnInit  {
  ...
  public lineChartData:Array<any> = [
    {data: [48, 48, 60, 39, 56, 37, 30], label: 'Auditoria'},
    {data: [ ] }
    
  ];
  public lineChartLabels:Array<any> = ['Contexto Organizacional', 'Liderazgo', 'Planificación', 'Apoyo', 'Operación'];
