...
@Component({
  selector: 'arbol-busquedaAvanzada',
  templateUrl: 'arbol-busquedaAvanzada-template.html',
  styleUrls: ['arbol-busquedaAvanzada-component.scss']
})

export class ArbolBusquedaAvanzadaCoTreeFlatOverviewData implements OnInit {
  //Arbol
  ...
  getLista(): void {    
    ...
    const parametros: 
    { codigo?: string, tipo?: string, id?: string, idTipoDocu?: string, tipoJerarquiaNombre?: string } =
    //{ codigo: null, tipo: tipoBandeja, id: null, idTipoDocu: idTipoDocumento, tipoJerarquiaNombre: null};
    { codigo: null, tipo: tipoBandeja, id: null, idTipoDocu: "1", tipoJerarquiaNombre: null};
