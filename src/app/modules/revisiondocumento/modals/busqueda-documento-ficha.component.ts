...
@Component({
  selector: 'app-busqueda-documento-ficha',
  templateUrl: './busqueda-documento-ficha.component.html'
  //styleUrls: ['./bitacora.component.scss']
})
export class BusquedaDocumentoFichaComponent implements OnInit {
  ...
  seleccionarDocumento() {
    ...
    if (this.selectedObject != null) {
      this.documento=this.selectedObject;
