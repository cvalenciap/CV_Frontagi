...
@Component({
  selector: 'bandeja-seguimiento-programa',
  templateUrl: './bandeja-seguimiento-programa.component.html',
  styleUrls: ['./bandeja-seguimiento-programa.component.scss']
})
export class BandejaSeguimientoProgramaComponent implements OnInit {
...
OnRevisionListaVer(): void {
  ...
  this.router.navigate([`consultaAuditoria/seguimiento-programacion/listaVer/1`]);
}
