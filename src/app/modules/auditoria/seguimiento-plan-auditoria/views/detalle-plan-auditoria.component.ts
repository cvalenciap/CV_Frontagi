...
import { Paginacion, Tipo, Parametro } from 'src/app/models';
...
import { ProgramacionAuditoriaService } from 'src/app/services';



@Component({
  selector: 'app-detalle-plan-auditoria',
  templateUrl: './detalle-plan-auditoria.component.html',
  styleUrls: ['./detalle-plan-auditoria.component.scss']
})
export class DetallePlanAuditoriaComponent implements OnInit {
  ...
  OnRegresar() {
    this.router.navigate([`consultaAuditoria/seguimiento-plan-auditoria`]);
  }
