...
@Component({
  selector: 'app-modal-busqueda-programacion',
  templateUrl: './modal-busqueda-programacion.component.html',
  styleUrls: ['./modal-busqueda-programacion.component.scss']
})
export class ModalBusquedaProgramacionComponent implements OnInit {
