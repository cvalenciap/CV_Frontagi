...
@Component({
  selector: 'bandeja-revision-auditoria',
  templateUrl: './bandeja-revision-auditoria.component.html',
  styleUrls: ['./bandeja-revision-auditoria.component.scss']
})
export class BandejaRevisionAuditoriaComponent implements OnInit {
  ...
  */
  ...
  OnRevisionListaVer(obj): void {
    this.selectedObject = obj;
    this.router.navigate([`auditoria/bandeja-revision-auditoria/listaVer/${this.selectedObject.numeroAuditoria}`]);
  }

  OnRevisionListaVerResposable(obj): void {
    this.selectedObject = obj;
    this.router.navigate([`auditoria/bandeja-revision-auditoria/listaVerAuditor/${this.selectedObject.numeroAuditoria}`]);
  }

  OnEnviarInforme(obj): void {
    this.selectedObject = obj;
    this.router.navigate([`auditoria/bandeja-revision-auditoria/enviarInforme/${this.selectedObject.numeroAuditoria}`]);
  }
