...
import { ListaEnviarInformes } from 'src/app/models/listaEnviarInformes';
...
export class EnviarInformeComponent implements OnInit {
  ...
  public onClose: Subject<DetalleProgramacion[]>;
  ...
  usuarioCreacionDefecto:string;
   ...
   selectedRow: number;
   selectedObject: ListaEnviarInformes;
   /* indicador de carga */
   loading: boolean;
   itemCodigo: number;
    /* datos */
    item: ListaEnviarInformes;
    private sub: any;
   ...
   // private service: BandejaRevisionAuditoriaService,
    ...
    this.paginacion = new Paginacion({registros: 10}
      ...
      getLista(): void {
       ...
       /* this.service.buscarEnviarInformes(parametros, this.paginacion.pagina, this.paginacion.registros).subscribe(
          (response: Response) => {
