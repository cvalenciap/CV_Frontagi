...
@Component({
  selector: 'app-modal-registro-detalle',
  templateUrl: './modal-registro-detalle.component.html',
  styleUrls: ['./modal-registro-detalle.component.scss'],
...
export class ModalRegistroDetalleComponent implements OnInit {
