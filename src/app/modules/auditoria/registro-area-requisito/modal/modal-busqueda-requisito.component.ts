...
@Component({
  selector: 'app-modal-busqueda-requisito',
  templateUrl: './modal-busqueda-requisito.component.html',
  styleUrls: ['./modal-busqueda-requisito.component.scss'],
  providers: [ProgramacionAuditoriaService]
})
export class ModalBusquedaRequisitoComponent implements OnInit {
