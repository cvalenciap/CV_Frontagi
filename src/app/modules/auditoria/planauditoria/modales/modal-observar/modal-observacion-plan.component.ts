...
@Component({
  selector: 'app-modal-observacion-plan',
  templateUrl: './modal-observacion-plan.component.html',
  styleUrls: ['./modal-observacion-plan.component.scss'],
  providers: [ProgramacionAuditoriaService]
})
export class ModalObservacionPlanComponent implements OnInit {
