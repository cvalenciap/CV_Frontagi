...
import { PlanAuditoriaMockService,PlanAuditoriaService, FichaRegistroAuditorService, GeneralService} from './../../../../../services/index';
...
@Component({
  selector: 'app-modal-busqueda-auditor',
  templateUrl: './modal-busqueda-auditor.component.html',
  styleUrls: ['./modal-busqueda-auditor.component.scss']
})
export class ModalBusquedaAuditorComponent implements OnInit {
