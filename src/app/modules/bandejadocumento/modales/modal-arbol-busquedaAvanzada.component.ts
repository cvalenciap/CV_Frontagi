...
import { ArbolBusquedaAvanzadaCoTreeFlatOverviewData } from '../../arbol/views/arbol-busquedaAvanzada-component';

declare var jQuery: any;
@Component({
  selector: 'bandeja-documento-arbol-busquedaAvanzada',
  templateUrl: 'modal-arbol-busquedaAvanzada.template.html',
})
export class ModalArbolBusquedaAvanzadaComponents implements OnInit {
  ...
  @ViewChild(ArbolBusquedaAvanzadaCoTreeFlatOverviewData) child: ArbolBusquedaAvanzadaCoTreeFlatOverviewData;
