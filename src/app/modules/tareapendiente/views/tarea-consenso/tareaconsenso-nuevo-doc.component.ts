...
@Component({
    selector: 'tareaconsenso-nuevo-doc',
    templateUrl: 'tareaconsenso-nuevo-doc.template.html',
    //styleUrls:['tareaelaboracion-nuevo-doc.component.scss']
})
export class ContenedorNuevoDocGoogleDocsConsenComponent implements OnInit {
  ...
  // @ViewChild('tabsDetalle') tabsDetalle: TabsetComponent;
    ...
    ngOnInit() {
        ...
        this.dataFase=JSON.parse(sessionStorage.getItem("Fase"));
