...
/******/ 	// The module cache
 ...
 /* var carName = "Volvsdso";
  document.getElementById("demo").write = carName;
*/
...
{
  /** @todo agregar otros posibles origenes */
  var HOSTED_VIEWER_ORIGINS = ['null', 'http://mozilla.github.io', 'https://mozilla.github.io', 'http://localhost:4200', 'http://sedapal.test', 'http://1.1.192.15', 'http://1.1.192.115', 'http://nginxtra.sedapal.com.pe', 'http://apitra.sedapal.com.pe', 'http://n1qa.sedapal.com.pe', 'http://apin1qa.sedapal.com.pe'];
...
var defaultOptions = {
  defaultUrl: {
    value: 'assets/sample.pdf', //'compressed.tracemonkey-pldi-09.pdf',
  ...
  locale: {
    value: 'es-ES', //typeof navigator !== 'undefined' ? navigator.language : 'en-US',
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
...
function applyParameterOverride(config) {
  ...
  if (getUrlParameterByName('flagPrint') === "false") {
    config.toolbar.print.setAttribute('hidden', 'true');
    /* config.secondaryToolbar.print.setAttribute('hidden', 'true'); */
  }
}
